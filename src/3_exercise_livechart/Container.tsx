import { useEffect, useRef, type ReactNode, type Dispatch } from 'react'
...
export const Container = ({ dispatch, children }: ContainerProps) => {
    ...
    <Exercise
      ...
      instructions={
        <>
          ...
          <ul style={{ paddingLeft: '0.5rem' }}>
            <li>
              The <code>Container.tsx</code> file must not be edited. Consider
